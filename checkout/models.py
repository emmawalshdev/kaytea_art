# uuid used to generate order number
import uuid
...
class Order(models.Model):
    ...
    # private method, generate order number
    ...
    def update_total(self):
        ...
        """
        # zero prevents an error if line items in order are deleted
    ...
    # override save method if order being saved has no order number
...
class OrderLineItem(models.Model):
    ...
    # lineitem_total = automatically calculated for each line item saved
